...
fn build_default_image() -> Result<(), String> {
    ...
    let root_files = [
        ...
        RootFile {
            path: "/compat/linux/dhcp-test",
            contents: &linux_dhcp_test,
            mode: 0o755,
            uid: 0,
            gid: 0,
        },
        ...
        RootFile {
            path: "/compat/linux/symlink-test",
            contents: &linux_symlink_test,
            mode: 0o755,
            uid: 0,
            gid: 0,
        },
        ...
        RootFile {
            path: "/compat/linux/flusher-test",
            contents: &linux_flusher_test,
            mode: 0o755,
            uid: 0,
            gid: 0,
        },
        RootFile {
            path: "/compat/linux/proc-conformance",
            contents: &linux_proc_conformance,
            mode: 0o755,
            uid: 0,
            gid: 0,
        },
